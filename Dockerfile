...
LABEL org.opencontainers.image.created="2026-09-19T00:40:29Z"
...
LABEL org.opencontainers.image.version="1.0.1-dev.2"
...
# http://localhost:5000/wps?request=DescribeProcess&service=WPS&identifier=all&version=1.0.1-dev.2
