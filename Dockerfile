...
LABEL org.opencontainers.image.created="2026-09-08T23:06:13Z"
...
LABEL org.opencontainers.image.version="1.0.1-dev.1"
...
# http://localhost:5000/wps?request=DescribeProcess&service=WPS&identifier=all&version=1.0.1-dev.1
