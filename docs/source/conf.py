...
sys.path.insert(0, os.path.abspath("/home/Shared/pingu/sandbox/birdhouse/emu/."))
...
latex_documents = [
  (master_doc, 'project.tex', u'Emu Documentation',
   u'Birdhouse', 'manual'),
]
...
man_pages = [
    (master_doc, 'project', u'Emu Documentation',
     [author], 1)
]
