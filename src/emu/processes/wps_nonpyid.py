...
class NonPyID(Process):
    def __init__(self):
        inputs = [
            LiteralInput("input 1", "Input1 number", default="100", data_type="integer"),
            ComplexInput(
                "input-2",
                "json input",
                supported_formats=[
        ...
        outputs = [
            LiteralOutput("output.1", "Add 1 to `input 1`.", data_type="float"),
            ComplexOutput(
                "output 2",
                "Same thing as input-2.",
                supported_formats=[
                    FORMATS.JSON,
                ],
            ),
        ...
        super().__init__(
            ...
            abstract="Dummy process whose process, input and output identifiers include characters not allowed in Python.",
            version="1.0",
            inputs=inputs,
            outputs=outputs,
