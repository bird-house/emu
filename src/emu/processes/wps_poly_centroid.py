...
class PolyCentroid(Process):
    def __init__(self):
        inputs = [
            LiteralInput(
                "wkt",
                "Region definition in WKT: Well-Known-Text format",
            ...
            ComplexInput(
                "xml",
                "Region definition in XML format",
    ...
    def _handler(request, response):
        ...
        response.outputs["output"].data = f"{centroid_x:.5f},{centroid_y:.5f}"
