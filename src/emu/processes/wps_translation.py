...
class Translation(Process):
    def __init__(self):
        ...
        super().__init__(
            ...
            keywords=["languages"],
            translations={
                "fr-CA": {"title": "Processus traduit", "abstract": "Processus incluant des traductions", "keywords": ["langues"]},
                "de-DE": {"title": "Mehrsprachiger Prozess", "abstract": "Prozess mit mehreren Sprachen.", "keywords": ["sprachen"]},
            },
        )
