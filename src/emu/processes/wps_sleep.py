...
class Sleep(Process):
    ...
    def __init__(self):
        inputs = [LiteralInput("delay", "Delay between every update", default="2", data_type="float")]
        ...
        super().__init__(
            ...
            version="1.0",
            title="Sleep Process",
            abstract="Testing a long running process, in the sleep. This process will sleep for a given delay or 10 seconds if not a valid value.",
            profile="",
            metadata=[
