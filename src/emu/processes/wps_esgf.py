    ...
    def __init__(self):
        inputs = [
            ...
            LiteralInput(
                ...
                metadata=[Metadata("application/x-ogc-dods", "https://www.iana.org/assignments/media-types/media-types.xhtml")],
                min_occurs=0,
                max_occurs=100,
            ),
        ]
        outputs = [LiteralOutput("output", "Output response", abstract="A summary report.", data_type="string")]
        ...
        super().__init__(
            ...
            metadata=[
                MetadataUrl("User Guide", "https://emu.readthedocs.io/en/latest/processes.html", anonymous=True),
                Metadata(
                    "ESGF Constraints",
                    role="https://www.earthsystemcog.org/spec/esgf_search/4.12.0/def/constraints",
                    href="http://esgf-data.dkrz.de/esg-search/search?project=CMIP5&time_frequency=mon&variable=tas,tasmax,tasmin&experiment=historical",
                ),
            ],
            version="1.0",
            inputs=inputs,
